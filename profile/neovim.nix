{ inputs, ... }:
{
  ...
  programs.nixvim = {
    ...
    keymaps = [
      ...
      { mode = ["v" "n"]; key = "m"; action = "h"; }
      { mode = ["v" "n"]; key = "n"; action = "j"; }
      { mode = ["v" "n"]; key = "e"; action = "k"; }
      { mode = ["v" "n"]; key = "i"; action = "l"; }
      { mode = ["v" "n"]; key = "j"; action = "e"; }
      { mode = ["v" "n"]; key = "k"; action = "n"; }
      { mode = ["v" "n"]; key = "l"; action = "i"; }
